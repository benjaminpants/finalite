...
bens_gear.register_on_all_materials_registered(function()
	...
	for i=1, #ores do
		if (ores[i].item_name ~= "finalite:finalite_ingot" and ores[i].item_name ~= "singularity:blackhole_ingot") then
...
minetest.register_node("finalite:finalite_smithing_table_cooking", {
	...
	on_timer = function(pos, elapsed)
		minetest.add_item({x = pos.x, y = pos.y + 1, z = pos.z},{name = "finalite:finalite_shard", count = math.random(1,2)})
